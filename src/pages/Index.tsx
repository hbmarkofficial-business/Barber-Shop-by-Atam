  ...
  return (
    <>
      <Helmet>
        ...
        <title>Barbershop Berlin | Barber Shop by Atam</title>
        <meta
          name="description"
          content="Besuche unseren Premium Barbershop Barber Shop by Atam in Berlin für erstklassige Haarschnitte, Bartpflege und individuelle Styles. Jetzt Termin buchen!"
        />
        <meta
          name="keywords"
        ...
        {/* Open Graph */}
        <meta property="og:title" content="Barber Shop by Atam | Premium Barbershop Berlin" />
        <meta
        ...
        <meta name="twitter:title" content="Barber Shop by Atam | Premium Barbershop Berlin" />
        <meta
